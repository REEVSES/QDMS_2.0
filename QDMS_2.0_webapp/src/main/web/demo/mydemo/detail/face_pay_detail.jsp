...
<%
    String result = SendHttpRequest.send(
            new String[]{"merchantNo"},
            new String[]{request.getParameter("merchantNo")},
            "/tradeInfo/faceTrade");
            ...
            success: function (json) {
                ...
                if (json.length == 0) {
                    ...
                    for (var i = 0; i < json.length; i++) {
                        var obj = json[i];
                        var tr_ = $("<tr  class='willDelete'><td>" + obj.tradeTime + "</td><td>" + obj.tradeCount + "</td><td>" + obj.tradeAmount + "</td><td>" + obj.tradeCharge + "</td><td>" + obj.tradeProfit + "</td></tr>");
                        $(".tbody").append(tr_);
