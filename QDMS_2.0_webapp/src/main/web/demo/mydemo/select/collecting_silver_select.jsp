...
<div class="demoTable" style="margin-top: 10px">
    <form class="layui-form" action="/export/collectingSilver" method="post">
...
<script>
    layui.use(['table', 'laydate'], function () {
        ...
        table.render({
            ...
            cols: [[
                {field: 'merchant_num', width: 140, event: "tt", title: '商户编码'}
                , {field: 'terminal_num', width: 90, event: "tt", title: '终端编号'}
                , {field: 'business_registration_name', width: 220, event: "tt", title: '工商注册名称'}
                , {field: 'merchant_signon_time', event: "tt", width: 110, title: '商户入网时间'}
                , {field: 'terminal_signon_time', width: 110, event: "tt", title: '终端入网时间'}
                , {field: 'guardian', width: 75, title: '维护人', event: "tt"}
                , {field: 'source_channel', width: 80, event: "tt", title: '来源渠道'}
                , {field: 'terminal_state', width: 80, event: "tt", title: '终端状态'}
                , {field: 'contact', width: 75, title: '联系人', event: "tt"}
                , {field: 'contact_num', width: 135, event: "tt", title: '联系电话'}
            ]],
            size: "sm"
            , skin: "line"
        });
        ...
        table.on('tool(test)', function (obj) {
            var data = obj.data;
            window.open("/demo/mydemo/detail/collecting_silver_detail.jsp?merchantNo=" + data.merchant_num + "&terminalNo=" + data.terminal_num);
        });
    });
